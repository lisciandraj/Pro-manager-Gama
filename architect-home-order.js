...
async function rpc(data={}){await window.GamaCloudReady;const c=await window.GamaCloud.db(),r=await c.rpc('gama_home_order',data);if(r.error)throw r.error;if(!r.data?.user_id)throw Error('AUTH_REQUIRED');return r.data}
