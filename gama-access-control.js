...
const ROLES={
 ...
 commercial:{label:'Comercial',perms:['projects','knowledge','payments','dossier-flow','settings','operations','notifications','gamaPurchasesV14','dashboard','products','clients','billing','reports','suppliers','matrix','customer-requests','price-lists','hr','crm','warehouses','sales-orders','quotes']},
