...
const ROLES={
 ...
 commercial:{label:'Comercial',perms:['knowledge','payments','dossier-flow','settings','operations','notifications','gamaPurchasesV14','dashboard','products','clients','billing','reports','suppliers','matrix','customer-requests','price-lists','hr','crm','warehouses','sales-orders','quotes']},
 magasinier:{label:'Almacenero',perms:['knowledge','dossier-flow','settings','operations','notifications','gamaPurchasesV14','dashboard','products','movement','stock','warehouses','barcode','tms','order-preparation','hr','sales-orders']},
