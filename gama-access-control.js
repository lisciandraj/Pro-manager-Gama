...
const ROLES={
 ...
 magasinier:{label:'Almacenero',perms:['operations','notifications','gamaPurchasesV14','dashboard','products','movement','stock','warehouses','barcode','locations','units','tms','hr','sales-orders']},
