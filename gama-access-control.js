...
const ROLES={
 ...
 commercial:{label:'Comercial',perms:['dashboard','products','clients','billing','reports','suppliers','matrix','customer-requests','price-lists','hr','crm','warehouses','sales-orders']},
 magasinier:{label:'Almacenero',perms:['dashboard','products','movement','stock','warehouses','barcode','locations','units','tms','hr','sales-orders']},
