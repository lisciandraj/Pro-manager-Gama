...
const routeTables={products:['products','suppliers'],clients:['customers'],stock:['products'],movement:['products'],barcode:['products'],audit:['products','stock_movements','profiles'],billing:['products','customers','invoices'],quotes:['products','customers']};
