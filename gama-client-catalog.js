...
function existencias(p){
 if(p.product_kind==='service')return '<span class=ccStock>Service · '+(window.GamaI18n?.language==='fr'?'date à convenir':'fecha por acordar')+'</span>';
