...
function ensureUI(){inject();let sec=$('client-catalog');if(!sec){sec=document.createElement('section');sec.id='client-catalog';(document.querySelector('.wrap')||document.body).appendChild(sec)}if(sec.dataset.ready)return;sec.dataset.ready='1';window.ArcUI.render(sec,`${window.GamaUI.header({title:'🛍️ Catálogo de productos',lead:'Elija sus productos y envíe el pedido a Coco ERP.'})}<div class="cc"><div class="ccTools"><input id="ccSearch" data-gi-placeholder=48d9573a38c4 placeholder="Buscar un producto…"><select id="ccCategory"><option value="" data-gi=425a839def0b>Todas las categorías</option></select><span class="badge" id="ccCount">0 productos</span></div><div class="muted" id="ccStatus"><span class="gamaSpin"></span>Cargando…</div><div class="ccGrid" id="ccProducts"></div><div class="ccFav" id="ccFav"><div class="ccFavHead"><h3 data-gi=cb6b4fa7ebba>⭐ Mis pedidos favoritos</h3></div><div id="ccFavRows" class="muted" data-gi=73a81c321e99>Sin favoritos guardados.</div></div><div class="ccCart"><div class="ccTools"><button class="arcButton secondary" id="ccHistory">Volver a pedir</button><button class="arcButton secondary" id="ccQuick">Añadir por referencia</button></div><div class="ccCartHead"><h3 data-gi=af887267f60d>🛒 Mi pedido</h3><b id="ccTotal">$0,00</b></div><div id="ccCartRows" style="margin:8px 0"><span class="muted" data-gi=a63b1e7d1713>Su pedido está vacío.</span></div><div class="ccResumen"><div><span data-gi=53de02aa48c6>Subtotal sin IVA</span><b id="ccNeto">$0,00</b></div><div><span data-gi=ba6da46c5e1c>IVA</span><b id="ccIva">$0,00</b></div><div class="ccResumenTotal"><span data-gi=0db5bb8bb2fe>Total con IVA</span><b id="ccBruto">$0,00</b></div></div><label>Fecha de entrega solicitada (pendiente de confirmación)<input id="ccDate" type="date"></label><textarea id="ccNotes" data-gi-placeholder=0ada0d45e88a placeholder="Comentario o indicación para el pedido…"></textarea><button class="arcButton primary" id="ccSend" style="width:100%;margin-top:9px" data-gi=10b4a1190405>Enviar pedido</button><button class="arcButton secondary" id="ccSaveFav" style="width:100%;margin-top:8px" data-gi=580cb2abec1a>☆ Guardar como favorito</button><div id="ccMsg" class="ccMsg"></div></div></div>`);window.GamaUI.bindBack(sec);$('ccSearch').oninput=()=>{GamaPage.reset('catalog');render()};$('ccCategory').onchange=()=>{GamaPage.reset('catalog');render()};GamaPage.register('catalog',render);$('ccSend').onclick=send;$('ccSaveFav').onclick=saveFavorite;$('ccHistory').onclick=history;$('ccQuick').onclick=quick}
