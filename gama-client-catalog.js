...
function inject(){if($('gamaClientCatalogStyle'))return;const s=document.createElement('style');s.id='gamaClientCatalogStyle';s.textContent=`#client-catalog{display:none}#client-catalog.active{display:block}.cc{container-type:inline-size;background:#fff;border:1px solid #E2E8EC;border-radius:16px;padding:16px;box-shadow:0 3px 16px #1732460d}.ccTools{display:flex;gap:9px;align-items:center;margin:16px 0;flex-wrap:wrap}.ccTools input{flex:1 1 260px;min-width:0;width:auto}.ccTools select{flex:0 0 auto;width:240px;min-width:0;padding:11px;border-radius:10px;border:1px solid #d4e0e4}.ccTools .badge{flex:0 0 auto;white-space:nowrap}
...
.ccProduct{display:grid;min-width:0;grid-template-columns:minmax(0,1fr);grid-template-rows:auto 1fr auto auto;grid-template-areas:'media' 'info' 'precio' 'acciones';gap:10px;border:1px solid #E2E8EC;border-radius:14px;padding:14px;background:#fff;box-shadow:0 1px 2px #1732460a;transition:box-shadow .12s ease,border-color .12s ease}
...
.ccProduct img,.ccNoImg{width:100%;height:140px;object-fit:contain;border-radius:10px;background:#F7F9FA}
...
.ccProduct h3{overflow-wrap:anywhere;font-size:15px;margin:0 0 3px;line-height:1.25;color:#173246}
.ccBarcode{font-size:12px;color:#516572;overflow-wrap:anywhere;margin-top:5px}.ccMeta{display:flex;flex-wrap:wrap;gap:4px 10px;font-size:11.5px;color:#71808A;margin-top:6px;overflow-wrap:anywhere}
...
.ccAcciones{grid-area:acciones;display:flex;gap:10px;align-items:center;margin-top:0;padding-top:10px;border-top:1px solid #EDF1F3}
.ccAdd{flex:1;background:#F47A2A;color:#fff;font-weight:800;font-size:12px;min-height:44px;min-width:0;border-radius:10px;padding:8px;display:flex;align-items:center;justify-content:center;gap:8px}
...
.ccQty{display:grid;grid-template-columns:32px 42px 32px;gap:0;flex:0 0 auto;border:1px solid #D4E0E4;border-radius:10px;overflow:hidden}
...
.ccQty input{min-width:0;width:100%;text-align:center;border:0;border-left:1px solid #D4E0E4;border-right:1px solid #D4E0E4;border-radius:0;font-size:15px;font-weight:700;padding:11px 0}
