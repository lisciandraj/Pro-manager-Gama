...
function bindPhotos(){
 document.querySelectorAll('.gamaExcelModes button').forEach(b=>b.onclick=()=>{
  ...
  const photos=b.dataset.mode==='photos';
  document.getElementById('gamaExcelPanelData').hidden=photos;
  document.getElementById('gamaExcelPanelPhotos').hidden=!photos;
 });
