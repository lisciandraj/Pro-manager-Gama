...
(function(){
  ...
  function installPurchasesButton(){
    const host=document.querySelector('.tabs');if(!host||host.querySelector('[data-gama-purchases-v14]'))return;
    const b=document.createElement('button');b.type='button';b.className='tab';b.dataset.gamaPurchasesV14='1';b.innerHTML='🛒<span>Achats</span>';b.onclick=function(){if(window.gamaShowPurchases)window.gamaShowPurchases();};host.appendChild(b);
  }
  async function boot(){
    try{
      mountExcel();installExcelButton();
