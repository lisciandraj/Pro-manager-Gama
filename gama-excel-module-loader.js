/* GAMA Module Loader — Excel + Achats V16 (robuste) */
(function(){
  'use strict';
  const PURCHASES='gama-purchases-v14.js?v=20260827-3';
  ...
  function installPurchases(){
    ...
    if(oldHost){
      let card=oldHost.querySelector('[data-gama-purchases-v16]');
    ...
    if(newHost){
      let card=newHost.querySelector('[data-gama-purchases-v16]');
