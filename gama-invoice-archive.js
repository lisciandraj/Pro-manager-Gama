...
function ensureSection(){const billing=document.getElementById('billing');if(!billing)return null;let card=document.getElementById('gamaInvoiceArchive');if(card)return card;card=document.createElement('div');card.id='gamaInvoiceArchive';card.className='card';window.ArcUI.render(card,`<div class="giaHead"><div><h2 data-gi=91b6b121b97f>📚 Archivo de presupuestos</h2><p class="muted" data-gi=7d8ecbef0369>Archivo cloud central • numeración incremental desde 000000001.</p></div><button class="arcButton secondary" type="button" id="giaRefresh" data-gi=c9618c5bc290>↻ Actualizar</button></div><div class="giaTools"><input id="giaSearch" data-gi-placeholder=bfc0b41b552c placeholder="Buscar por número, cliente o RUC/Cédula..."><span id="giaCount" class="badge">0 presupuestos</span></div><div id="giaRows"><div class="giaEmpty"><span class="gamaSpin"></span>Cargando presupuestos…</div></div><div id="giaPager" class="giaPager"></div><div id="giaView"></div>`);
