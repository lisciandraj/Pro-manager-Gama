...
const ITEMS=[
 ...
 ['Control comercial y logístico','operations','chart','Resumen'],
 ['Notificaciones','notifications','request','Resumen'],
 ...
 ['Pagos de clientes','payments','invoice','Ventas'],
 ['Preparación de pedidos','order-preparation','stock','Logística'],
