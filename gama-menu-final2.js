...
'use strict';
const ITEMS=[
 ['Panel de control','dashboard','chart'],['Productos','products','cube'],['Clientes','clients','users'],['Entradas / Salidas','movement','move'],['Facturación','billing','invoice'],['Inventario','stock','stock'],['Auditoría','audit','audit'],['Proveedores','suppliers','truck'],['Importar Excel','reports','spreadsheet'],['Configuración','settings','gear'],['Copias de seguridad','backup','cloud'],['Usuarios','users','user'],['Notificaciones','notifications','bell'],['Tareas','tasks','task'],['Agenda','calendar','calendar'],['Etiquetas','labels','tag'],['Ubicaciones','locations','pin'],['Códigos de barras','barcode','barcode'],['Unidades','units','ruler'],['Ayuda y soporte','support','help']
];
const I={
