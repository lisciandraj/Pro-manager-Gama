...
function hook(){injectStyles();section('matrix','📊 Matriz comercial',MAT_LEAD);patchMenu();fetchSuppliers().then(s=>{cloudSuppliers=s}).catch(()=>{});const old=window.showTab;if(old&&!old.__gamaPM){window.showTab=function(id,el){if(id==='suppliers')renderSuppliers();if(id==='matrix')renderMatrix();return old.apply(this,arguments)};window.showTab.__gamaPM=true}}
