...
(function(){
  ...
  let loading=false, selectedId=null, draft=[], projectContext=null, projectSaveKey=null;
  ...
  const money=n=>new Intl.NumberFormat(window.GamaI18n?.locale||'es-EC',{style:'currency',currency:'USD',currencyDisplay:'narrowSymbol',minimumFractionDigits:2,maximumFractionDigits:2}).format(Number(n||0));
  ...
  function inject(){
    ...
    const s=document.createElement('section');s.id='gamaPurchasesV14';s.innerHTML=`
      ...
      <div class="card gp14LowStock" id="gp14LowStock" style="display:none"></div>
      <div class="gp14Grid"><div class="card gp14Form"><div class="gp14Title"><h3 data-gi=78205ea91be9>Nuevo pedido a proveedor</h3><span class="gp14Role" id="gp14Role"></span></div>
      ...
      <label data-gi=ae0e47ca14d2>Producto *</label><select id="gp14Product"><option value="" data-gi=b9d4bce5023b>Seleccionar producto…</option></select>
      ...
      <button class="secondary gp14Full" id="gp14Add" data-gi=93f051a1deca>＋ Añadir producto</button><div id="gp14Draft" class="gp14DraftBox"></div>
  ...
  function style(){if($('gp14Css'))return;const s=document.createElement('style');s.id='gp14Css';s.textContent=`#gamaPurchasesV14{display:none}.gp14Kpis{display:grid;grid-template-columns:repeat(5,1fr);gap:10px;margin:12px 0}.gp14Kpis>div{background:#fff;border:1px solid var(--arc-line);border-radius:13px;padding:13px}.gp14Kpis span{display:block;color:var(--arc-text-muted);font-size:11px;font-weight:700}.gp14Kpis b{display:block;margin-top:6px;font-size:21px;color:var(--arc-text)}.gp14Grid{display:grid;grid-template-columns:.9fr 1.3fr;gap:12px}.gp14Form{position:relative}.gp14Title,.gp14ListHead,.gp14DetailHead{display:flex;justify-content:space-between;align-items:center;gap:10px}.gp14Title h3,.gp14ListHead h3{margin:0}.gp14Role{font-size:10px;padding:5px 8px;border-radius:999px;background:var(--arc-surface-3);color:var(--arc-accent-600);font-weight:800}.gp14Full{width:100%;margin:14px 0 10px}.gp14DraftBox{margin:8px 0}.gp14DraftLine{display:grid;grid-template-columns:1fr 65px 90px 30px;gap:7px;align-items:center;border-bottom:1px solid var(--arc-surface-3);padding:8px 0;font-size:12px}.gp14DraftLine small{display:block;color:var(--arc-text-muted)}.gp14X{padding:5px;background:var(--arc-danger-bg);color:var(--arc-danger)}.gp14ListHead small{display:block;color:var(--arc-text-muted);margin-top:3px}.gp14ListHead select{width:auto;min-width:150px;padding:9px}.gp14Order{border:1px solid var(--arc-line);border-radius:12px;padding:12px;margin-top:9px;cursor:pointer}.gp14Order:hover{border-color:var(--arc-accent-600)}.gp14OrderTop{display:flex;justify-content:space-between;gap:10px}.gp14OrderTop b{color:var(--arc-text)}.gp14Status{display:inline-block;padding:4px 8px;border-radius:999px;font-size:10px;font-weight:800}.gp14Draft{background:var(--arc-surface-3);color:var(--arc-text-muted)}.gp14Sent{background:var(--arc-accent-100);color:var(--arc-accent-700)}.gp14Partial{background:var(--arc-warning-bg);color:var(--arc-warning)}.gp14Received{background:var(--arc-success-bg);color:var(--arc-success)}.gp14Cancelled{background:var(--arc-danger-bg);color:var(--arc-danger)}.gp14Meta{display:flex;justify-content:space-between;gap:8px;color:var(--arc-text-muted);font-size:11px;margin-top:6px}.gp14Meta b{color:var(--arc-text)}.gp14Detail{margin-top:12px}.gp14DetailHead h3{margin:0}.gp14ReceiveLine{display:grid;grid-template-columns:1.6fr 85px 95px 105px;gap:8px;align-items:center;border-bottom:1px solid var(--arc-surface-3);padding:11px 0}.gp14ReceiveLine small{display:block;color:var(--arc-text-muted)}.gp14ReceiveLine input{padding:8px}.gp14Locked{padding:10px;border-radius:9px;background:var(--arc-surface-2);color:var(--arc-text-muted);font-size:12px}.gp14Actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:12px}.gp14Msg{margin-top:9px;font-size:12px;color:var(--arc-danger)}.gp14Ok{color:var(--arc-success)}.gp14Info{background:var(--arc-surface-2);border-left:4px solid var(--arc-accent-600);padding:10px;border-radius:8px;font-size:12px;margin:10px 0}.gp14Warn{background:var(--arc-warning-bg);border-left:4px solid var(--arc-warning);padding:10px;border-radius:8px;font-size:12px;margin:10px 0}.gp14LowStock{border-left:4px solid var(--arc-danger)}.gp14LowStock h3{margin:0 0 10px;color:var(--arc-danger);font-size:16px}.gp14LowGroup{border:1px solid var(--arc-line);border-radius:10px;padding:10px;margin-top:9px}.gp14LowGroupHead{display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap}.gp14LowRow{display:grid;grid-template-columns:1fr 90px 60px;gap:8px;align-items:center;border-top:1px solid var(--arc-surface-3);padding:8px 0;font-size:12px}.gp14LowRow small{display:block;color:var(--arc-text-muted)}@media(max-width:800px){.gp14Grid{grid-template-columns:1fr}.gp14Kpis{grid-template-columns:1fr 1fr}.gp14Kpis>div:last-child{grid-column:span 2}.gp14OrderTop,.gp14Meta{flex-direction:column}.gp14ReceiveLine{grid-template-columns:1fr 75px 85px 95px}.gp14ListHead{align-items:flex-start;flex-direction:column}.gp14ListHead select{width:100%}}`;document.head.appendChild(s)}
  ...
  function productoElegido(){
   ...
   if(!p)return;
   $('gp14Cost').value=Number(p.purchase_price||0).toFixed(2);
  ...
  window.gamaCreateProjectPurchase=async context=>{
   ...
   const t=window.GamaProjects.t;box.innerHTML='<b>'+esc(context.project_name)+'</b><div class="pmForm"><label>'+esc(t('source_currency'))+'<input id="gp14ProjectCurrency" value="'+esc(context.currency)+'" maxlength="3" required></label><label>'+esc(t('exchange_rate'))+'<input id="gp14ProjectFx" type="number" min="0.000001" step="any" value="1" required></label></div>';box.hidden=false;
  ...
  function installTab(){const host=document.querySelector('.tabs');if(!host||$('gamaPurchasesV14Tab'))return;const b=document.createElement('button');b.id='gamaPurchasesV14Tab';b.type='button';b.className='tab';b.innerHTML='🛒<span data-gi=1bc70818a30d>Compras</span>';b.onclick=show;host.appendChild(b)}
  function populate(){const ss=$('gp14Supplier'),ps=$('gp14Product');if(!ss||!ps)return;ss.innerHTML='<option value="" data-gi=5c9d95219fe7>Seleccionar proveedor…</option>'+suppliers.filter(x=>x.active!==false).map(x=>`<option value="${x.id}">${esc(x.name)}${x.tax_id?' — '+esc(x.tax_id):''}</option>`).join('');ps.innerHTML='<option value="" data-gi=b9d4bce5023b>Seleccionar producto…</option>'+products.filter(x=>x.active!==false).map(x=>`<option value="${x.id}">${esc(x.name)}${x.barcode?' — '+esc(x.barcode):''}</option>`).join('');$('gp14Role').textContent=roleLabel(sessionRole())}
  ...
  function renderDraft(){const h=$('gp14Draft');if(!draft.length){h.innerHTML='<div class="muted" data-gi=e708556f30d1>No hay productos en el pedido.</div>';return}h.innerHTML=draft.map((l,i)=>{const p=products.find(x=>x.id===l.product_id);return `<div class="gp14DraftLine"><div><b>${esc(p?.name||'Producto')}</b><small>${esc(p?.reference||p?.barcode||'')}</small></div><span>${l.quantity}</span><span>${money(l.quantity*l.unit_cost)}</span><button class="gp14X" onclick="window.gamaRemovePurchaseLineV14(${i})">×</button></div>`}).join('')}
  ...
  async function saveOrder(){if(!canOrder())return alert('Tu perfil no puede crear pedidos a proveedores.');let sid=$('gp14Supplier').value;if(!sid)return alert('Selecciona un proveedor.');if(!draft.length)return alert('Añade al menos un producto.');if(sid.startsWith('legacy:')){if(!window.gamaResolveSupplierId)return msg('No se pudo sincronizar el proveedor con la nube. Inténtalo de nuevo.');msg('Sincronizando proveedor con la nube…');const resolved=await window.gamaResolveSupplierId(sid);if(!resolved)return msg('No se pudo sincronizar este proveedor con la nube. Verifica tu conexión e inténtalo de nuevo.');sid=resolved;$('gp14Supplier').value=sid}const subtotal=draft.reduce((a,l)=>a+l.quantity*l.unit_cost,0);const session=(await C().getSession()).data?.session;const row={supplier_id:sid,order_number:nextNumber(),order_date:new Date().toISOString(),expected_date:$('gp14Expected').value?new Date($('gp14Expected').value+'T12:00:00').toISOString():null,status:'draft',notes:[$('gp14SupplierRef').value.trim()?('Ref. proveedor: '+$('gp14SupplierRef').value.trim()):'', $('gp14Notes').value.trim()].filter(Boolean).join(' | ')||null,subtotal,tax:0,total:subtotal,created_by:session?.user?.id||null};if(projectContext){
 const savedContext=projectContext,button=$('gp14Save');button.disabled=true;
 try{const result=await window.GamaProjects.rpc('create_purchase',{project_id:savedContext.project_id,id:savedContext.item_id,request_key:projectSaveKey,supplier_id:sid,expected_date:row.expected_date,notes:row.notes,currency:$('gp14ProjectCurrency').value.toUpperCase(),exchange_rate:Number($('gp14ProjectFx').value),lines:draft.map(l=>({...l}))},true);clearForm();await load();await openOrder(result.purchase_id);msg(window.GamaProjects.t('saved'),true)}catch(e){msg(window.GamaProjects.error(e))}finally{button.disabled=false}return;
 }const r=await C().insert('purchase_orders',row);if(r.error)return msg('No se pudo crear el pedido: '+r.error.message);const po=r.data;if(!po)return msg('No se ha podido crear el pedido.');for(const l of draft){const x=await C().insert('purchase_order_lines',{purchase_order_id:po.id,product_id:l.product_id,quantity:l.quantity,received_quantity:0,unit_cost:l.unit_cost,tax_rate:0,line_total:l.quantity*l.unit_cost});if(x.error){await C().remove('purchase_orders',po.id);return msg('Error en una línea: '+x.error.message)}}clearForm();msg('Pedido creado. El inventario no cambia hasta la recepción.',true);await load()}
  function msg(t,ok){const m=$('gp14Msg');m.textContent=t;m.className='gp14Msg '+(ok?'gp14Ok':'')}
  function clearForm(){projectContext=null;projectSaveKey=null;if($('gp14ProjectContext')){$('gp14ProjectContext').hidden=true;$('gp14ProjectContext').replaceChildren()}$('gp14Supplier').value='';$('gp14Expected').value='';$('gp14SupplierRef').value='';$('gp14Product').value='';$('gp14Qty').value='1';$('gp14Cost').value='0';$('gp14Notes').value='';draft=[];renderDraft();msg('')}
  ...
  const PRODUCT_COLS='id,name,reference,barcode,purchase_price,stock,min_stock,active,supplier_id';
  ...
  function renderLowStock(){const host=$('gp14LowStock');if(!host)return;const low=needs;if(!low.length){host.style.display='none';host.innerHTML='';return}host.style.display='block';const groups=new Map();low.forEach(n=>{const key=n.supplier_id||'__none';if(!groups.has(key))groups.set(key,[]);groups.get(key).push(n)});const cards=[...groups.entries()].map(([sid,items])=>{const name=sid==='__none'?'Sin proveedor asignado':supplierName(sid);const rows=items.map(n=>`<div class="gp14LowRow"><div><b>${esc(n.name)}</b><small>${esc(n.reference||'')} · Físico ${numPurchase(n.on_hand)} · Reservado ${numPurchase(n.reserved)} · Demanda ${numPurchase(n.sales_demand)} · Entrante ${numPurchase(n.incoming)}</small></div><span>Disp. ${numPurchase(n.available)}</span><span><b>+${numPurchase(n.suggested_purchase)}</b></span></div>`).join('');const canAct=sid!=='__none';return `<div class="gp14LowGroup"><div class="gp14LowGroupHead"><b>${esc(name)}</b>${canAct&&canOrder()?`<button class="secondary" type="button" onclick="window.gamaAddLowStockGroup('${esc(sid)}')" data-gi=1a3be45047b8>＋ Preparar pedido</button>`:canAct?'':'<span class="muted" data-gi=9c95809f22c9>Asigna un proveedor en Productos</span>'}</div>${rows}</div>`}).join('');host.innerHTML=`<h3>⚠️ Necesidades de aprovisionamiento — ${low.length}</h3><p class="muted" data-gi=8d4fd632a8e0>Calculadas con stock físico, reservas de ventas, demanda pendiente y compras ya en camino.</p>${cards}`}
  ...
  window.gamaPrepareActionPurchase=async ({order_id,product_id})=>{
   ...
   window.GamaSales.modal('Preparar compra',`<p data-gi=776b07bb30c1>Necesidades actuales de los productos del dossier, descontando compras en camino. Revisa las cantidades antes de guardar.</p>${candidates.some(n=>!n.supplier_id)?'<p data-gi=b235194cf12d>Hay productos sin proveedor: asígnalo en Productos para comprarlos.</p>':''}<label data-gi=e746643f4479>Proveedor<select id="gpActionSupplier">${groups.map(id=>`<option value="${esc(id)}">${esc(supplierName(id))}</option>`).join('')}</select></label>`,'Preparar',async el=>{
    ...
    $('gp14Supplier').value=sid;if($('gp14Supplier').value!==sid)throw Error('El proveedor no está disponible. Actualiza Compras.');draft=selected.map(n=>({product_id:n.product_id,quantity:Number(n.suggested_purchase),unit_cost:Number(products.find(p=>p.id===n.product_id).purchase_price||0)}));renderDraft();msg('Compra preparada. Revisa las cantidades y guarda el pedido.',true);document.querySelector('.gp14Form')?.scrollIntoView({behavior:'smooth',block:'start'});
   });
  };
  window.gamaAddLowStockGroup=function(sid){if(!canOrder())return alert('Tu perfil no puede crear pedidos a proveedores.');const selected=needs.filter(n=>n.supplier_id===sid);if(!selected.length)return;$('gp14Supplier').value=sid;selected.forEach(n=>{const p=products.find(x=>x.id===n.product_id);if(!p)return;const suggest=Number(n.suggested_purchase);const existing=draft.find(x=>x.product_id===p.id);if(existing)existing.quantity=Math.max(existing.quantity,suggest);else draft.push({product_id:p.id,quantity:suggest,unit_cost:Number(p.purchase_price||0)})});renderDraft();msg(selected.length>1?'Se prepararon '+selected.length+' productos según la necesidad calculada.':'Se preparó 1 producto según la necesidad calculada.',true);document.querySelector('.gp14Form')?.scrollIntoView({behavior:'smooth',block:'start'})};
  ...
  function renderOrders(){const h=$('gp14Orders');if(!h)return;const f=$('gp14Filter')?.value||'all';const arr=orders.filter(o=>f==='all'||o.status===f).sort((a,b)=>new Date(b.order_date)-new Date(a.order_date));if(!arr.length){h.innerHTML='<div class="muted" style="padding:20px 0" data-gi=828814d36c0a>No hay pedidos para mostrar.</div>';return}h.innerHTML=GamaPage.slice('purchaseOrders',arr).map(o=>{const ls=lines.filter(l=>l.purchase_order_id===o.id);const qty=ls.reduce((a,l)=>a+Number(l.quantity||0),0),rec=ls.reduce((a,l)=>a+Number(l.received_quantity||0),0);return `<div class="gp14Order" onclick="window.gamaOpenPurchaseV14('${o.id}')"><div class="gp14OrderTop"><b>${esc(o.order_number)}</b><span class="gp14Status ${statusClass(o.status)}">${statusLabel(o.status)}</span></div><div class="gp14Meta"><span>${esc(supplierName(o.supplier_id))}</span><span>${rec}/${qty} · ${money(o.total)}</span></div><div class="gp14Meta"><span><span data-gi=916801fe1ea1>Pedido: </span>${date(o.order_date)}</span><span><span data-gi=f5573964a548>Previsto: </span>${date(o.expected_date)}</span></div></div>`}).join('')+GamaPage.controls('purchaseOrders',arr.length)}
  window.gamaOpenPurchaseV14=openOrder;
  async function openOrder(id){selectedId=id;const o=orders.find(x=>x.id===id);if(!o)return;const ls=lines.filter(x=>x.purchase_order_id===id);const d=$('gp14Detail');d.style.display='block';const canRecv=canReceive()&&['sent','partial'].includes(o.status);const allReceived=ls.length>0&&ls.every(l=>Number(l.received_quantity)>=Number(l.quantity));d.innerHTML=`<div class="gp14DetailHead"><div><h3><span data-gi=9e9ea5774a2d>Pedido </span>${esc(o.order_number)}</h3><div class="muted">${esc(supplierName(o.supplier_id))} · ${statusLabel(o.status)}</div></div><button class="secondary" onclick="window.gamaClosePurchaseV14()" data-gi=aeccae342e4b>Cerrar</button></div><div class="gp14Info">${o.status==='draft'?'Al enviar el pedido se prepara un correo con el PDF adjunto para el proveedor y el pedido pasa a estado «Pedido realizado».<br>':''}Una recepción validada crea automáticamente un movimiento de <b data-gi=b40b2944d0e8>Entrada</b>, aumenta el inventario y registra el precio de compra.${ubicaciones.length?' La mercancía entra en la ubicación que elijas abajo.':''}</div>${ls.map(l=>{const p=products.find(x=>x.id===l.product_id);const pending=Math.max(0,Number(l.quantity)-Number(l.received_quantity));return `<div class="gp14ReceiveLine"><div><b>${esc(p?.name||'Producto')}</b><small><span data-gi=916801fe1ea1>Pedido: </span>${l.quantity} · Recibido: ${l.received_quantity} · Pendiente: ${pending}</small></div><span>${money(l.unit_cost)}</span><span>${pending?'<input id="gp14Recv_'+l.id+'" type="number" min="0" max="'+pending+'" step="0.01" value="'+pending+'" '+(canRecv?'':'disabled')+'>':'<span class="gp14Status gp14Received" data-gi=23e3685fbe6c>Completo</span>'}</span><span>${money(Number(l.quantity)*Number(l.unit_cost))}</span></div>`}).join('')}${o.notes?`<div class="gp14Warn">${esc(o.notes)}</div>`:''}${canRecv?selectorUbicacion(true):''}<label data-gi=59b6c0ea5e7b>Comentario de recepción</label><textarea id="gp14ReceiveComment" data-gi-placeholder=c64dd7b6130a placeholder="Albarán, lote, transporte, incidencia…" ${canRecv?'':'disabled'}></textarea><div class="gp14Actions">${o.status==='draft'&&canOrder()?`<button class="primary" onclick="window.gamaSendPurchaseV14('${o.id}')" data-gi=d14e8167e003>✉️ Enviar pedido por correo</button><button class="secondary" onclick="window.gamaDownloadPurchaseV14('${o.id}')" data-gi=272abf6e4139>📄 Descargar PDF</button>`:''}${canRecv?`<button class="success" onclick="window.gamaReceivePurchaseV14('${o.id}')" data-gi=a00b941481f7>📦 Registrar recepción</button>`:''}${o.status==='sent'&&canOrder()?`<button class="danger" onclick="window.gamaCancelPurchaseV14('${o.id}')" data-gi=9f98a45211d0>Cancelar pedido</button>`:''}${ls.some(l=>Number(l.received_quantity)>0)?`<button class="secondary" onclick="window.GamaReturns?.createFrom('supplier','${o.id}')" data-gi-live data-gi=a2ca74474012>↩ Crear una devolución</button>`:''}${allReceived?'<span class="gp14Locked" data-gi=b30ad6797230>Todas las cantidades ya han sido recibidas.</span>':''}</div><div id="gp14DetailMsg" class="gp14Msg"></div>`}
  ...
  window.addEventListener('gama:auth-change',()=>{projectContext=null;projectSaveKey=null;draft=[];$('gp14ProjectContext')?.remove()});
  ...
  async function boot(){if(window[MOD])return;window[MOD]=true;try{inject();installTab();await load();subscribe()}catch(e){console.warn('[GAMA Compras V14]',e)}}
