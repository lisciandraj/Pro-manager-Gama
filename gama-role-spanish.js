...
function loadTMS(){
 ...
 s.src='gama-tms-module.js?v=20260913-autoinvoice1';
 s.onload=()=>addTMSCard();
...
function addTMSCard(){
 ...
 b.innerHTML='<span class="gamaF2Icon" style="background:#e8f5f6;color:#087c8b"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M3 7h11v10H3zM14 10h4l3 3v4h-7z"/><circle cx="7" cy="19" r="2"/><circle cx="18" cy="19" r="2"/></svg></span><span class="gamaF2Title" data-gi=5f4486d79444>Entregas / TMS</span>';
