...
async function start(id){
 ...
 overlay.innerHTML='<div class="h"><div class="title" data-gi=4791a6ffaf10>Escanear código de barras</div><button class="arcButton close" type="button" data-gi=aeccae342e4b>Cerrar</button></div><div class="video"><video playsinline webkit-playsinline muted autoplay></video><div class="frame"></div></div><div class="status" role="status" aria-live="polite" data-gi=e6013f70ce82>Activando cámara…</div><p class="help" hidden></p><a class="diagnostic" href="./camera-check.html" hidden style="color:#fff;padding:8px 0" data-gi=5ccd0440945f>Probar cámara fuera del ERP</a><div class="diagnosticCode" hidden style="font-size:12px;overflow-wrap:anywhere"></div><div class="recovery"><button type="button" class="arcButton retry" data-gi=9984cd2d2ebd>Reintentar cámara</button><button type="button" class="arcButton manual" data-gi=08e635b52494>Introducir código</button></div>';
