...
window.GamaCloudReady=init().then(function(){['gama-cloud-products.js?v=19','gama-cloud-auth.js?v=19','gama-cloud-users.js?v=20','gama-purchases-supplier-bridge.js?v=5','gama-invoice-archive.js?v=6'].forEach(function(src){const s=document.createElement('script');s.src=src;s.async=true;document.head.appendChild(s)});return window.GamaCloud});
})();
