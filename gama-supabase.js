...
window.GamaCloudReady=init().then(function(){['gama-cloud-products.js?v=20260913-i18n1','gama-cloud-auth.js?v=20260913-i18n1','gama-cloud-users.js?v=20260913-i18n1','gama-purchases-supplier-bridge.js?v=20260913-i18n1','gama-invoice-archive.js?v=20260913-i18n1'].forEach(function(src){const s=document.createElement('script');s.src=src;s.async=true;document.head.appendChild(s)});return window.GamaCloud});
})();
