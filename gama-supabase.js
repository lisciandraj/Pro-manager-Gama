...
window.GamaCloudReady=init().then(function(){['gama-cloud-products.js?v=12','gama-cloud-auth.js?v=12','gama-purchases-supplier-bridge.js?v=3'].forEach(function(src){const s=document.createElement('script');s.src=src;s.async=true;document.head.appendChild(s)});return window.GamaCloud});
})();