...
language sql security invoker set search_path='' as $fn$select private.gama_tms_resources()$fn$;
...
begin
 ...
 if position(old in src)=0 then raise exception 'ANCHOR_CATALOG';end if;
