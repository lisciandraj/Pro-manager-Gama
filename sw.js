const CACHE = 'gama-settings-20260913-1';
const APP_SHELL = ['./', './index.html', './manifest.json', './gama-i18n-catalog.js?v=20260913-settings1', './gama-i18n.js?v=20260913-settings1'];
