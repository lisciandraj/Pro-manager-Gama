const CACHE = 'architect-erp-20260919-order1';
const APP_SHELL = ['./architect-logo.png', './architect-shell.css?v=20260919-order1', './architect-home.css?v=20260919-order1', './', './index.html', './manifest.json?v=20260919-reference1', './architect-tokens.css?v=20260919-reference1', './architect-ui.css?v=20260919-reference1', './gama-i18n-catalog.js?v=20260919-company1', './gama-i18n.js?v=20260919-reference1', './gama-currency.js?v=20260917-accounting1'];
