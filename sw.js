const CACHE = 'gama-tms-controls-20260913-1';
const APP_SHELL = ['./', './index.html', './manifest.json', './gama-i18n-catalog.js?v=20260913-tmscontrol1', './gama-i18n.js?v=20260913-accesssettings1'];
