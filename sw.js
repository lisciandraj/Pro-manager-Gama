const CACHE = 'gama-table-client-header-20260913-1';
const APP_SHELL = ['./', './index.html', './manifest.json', './gama-i18n-catalog.js?v=20260913-prepmodule1', './gama-i18n.js?v=20260913-accesssettings1'];
