...
test.describe('Product list — assign a supplier', () => {
  ...
  // purchase_price could only be set indirectly by receiving a purchase
  // order, with no way to enter it on the product sheet itself. Compras
  // (unit cost defaults) and the sales-margin report both read it.
